...
func formatEnvFile(env map[string]string) (string, error) {
	order := []string{
		...
		"INDEXER_DB_BUSY_TIMEOUT", "INDEXER_DB_JOURNAL_MODE",
		"INDEXER_DB_SYNCHRONOUS", "INDEXER_DB_AUTO_VACUUM",
		"INDEXER_DB_MAX_OPEN_CONNS", "INDEXER_DB_MAX_IDLE_CONNS",
		"INDEXER_DB_CONN_MAX_IDLE_TIME",
