...
- Plain terminal overview for API stats plus socket/timer state.
...
- `indexer status` prints a plain status overview and may socket-activate the API daemon.
...
│       ├── status_overview.go # Plain terminal status overview
